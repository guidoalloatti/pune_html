...
<html> 
    ...
    <body>
		...
		<table>
			...
			<tr>
				<td><input type="label" style="color: red; background: lightgray; font-size: 12pt;" value="Red Worm" readonly="true" /></td>
			...
			<tr>
				<td><input type="label" style="color: blue; background: gray; font-size: 12pt;" value="Blue Worm" readonly="true" /></td>
				<td align="center"><input type="checkbox" id="blue_play" onclick="player_selected(\'blue\');" /></td>
			...
			<tr>
				<td><input type="label" style="color: green; background: lightgray; font-size: 12pt;" value="Green Worm" readonly="true" /></td>
			...
			<tr>
				<td><input type="label" style="color: purple; background: gray; font-size: 12pt;" value="Purple Worm" readonly="true" /></td>
			...
			<tr>
				<td><input type="label" style="color: cyan; background: lightgray; font-size: 12pt;" value="Cyan Worm" readonly="true" /></td>
			...
			<tr>
				<td><input type="label" style="color: yellow; background: gray; font-size: 12pt;" value="Yellow Worm" readonly="true" /></td>

...
Update: This project now runs as a static HTML app (index.html) with localStorage-based settings/keys, PixiJS rendering, no jQuery dependency, and an optional realtime server for online play.